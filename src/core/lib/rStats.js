...
window.rStats = function rStats ( settings ) {
    ...
    var _cssRStats = window.location.origin + '/rStats.css';
    ...
    function StackGraph ( _dom, _num ) {
        ...
        function _draw ( v ) {
            ...
            _ctx.fillStyle = _colours[ 2 ];
            _ctx.fillRect( _canvas.width - 1, th, 1, -_canvas.height );
        }
    ...
    function _init () {
        ...
        _base.style.cssText = 'position:absolute;cursor:pointer;';
