...
export default class TopFed {
    ...
    getLower(origin, sizes) {
        ...
        this.texts.push({
            position: new THREE.Vector3(x - w - textShiftFactorDxf + 20, y + h + 16),
            text: `(${placeHolder}) XX A MAIN SERVICE PANEL`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w - textShiftFactorDxf + 20, y + h + 8),
            text: `WITH (${placeHolder}) XX A MAIN BREAKER`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w - textShiftFactorDxf + 20, y + h),
            text: '                                   (TOP FED)',
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info, [x - w, y + h + 5], 4));
        ...
        this.leaders.push([
                new THREE.Vector3(X - 5, y + (5 * (h / 6))),
                new THREE.Vector3(x - 4, y + h + 2),
                new THREE.Vector3(x - 9, y + h + 2),
            ]
        );
        this.sldObjectsGroup.add(getLine([X - 5, y + (5 * (h / 6))], [x - 4, y + h + 2]));
        this.sldObjectsGroup.add(getLine([x - 9, y + h + 2], [x - 4, y + h + 2]));
