...
export default class NoMain {
    ...
    getLower(origin, sizes) {
        ...
        // {
        //     if(infoBreakerSize % 5 == 0 && this.wireSize.breakerSizes.utilityMeter != infoBreakerSize) {
        //         infoBreakerSize++;
        //     }
        //     for(let i = 1; i < 5; i++) {
        ...
        const info4 = `(N) ${placeHolder2} A`;

        this.texts.push({
            position: new THREE.Vector3(x - w + 5, y + h + 10),
            text: `(${placeHolder}) XX A MAIN SERVICE PANEL`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w + 5, y + h + 2),
            text: 'WITH NO MAIN BREAKER',
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info, [x - w + 15, y + h + 10], 4));

        this.texts.push({
            position: new THREE.Vector3(x - w + 10, y + h - 10),
            text: `(N) ${placeHolder2} A PV BREAKER`,
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info2, [x - w + 15, y + h - 10], 4));

        this.texts.push({
            position: new THREE.Vector3(X - (w / 4), Y - (h / 6) + 6),
            text: `(N) ${placeHolder2} A`,
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info4, [X - (w / 4) - 1, Y - (h / 6) + 6], 4));
        this.leaders.push([
            new THREE.Vector3(X - (w / 4) - 7.33, Y - (h / 6) + 0.5),
            new THREE.Vector3(x - 4, Y - (h / 6) + 2.5),
            new THREE.Vector3(x - 4, y + h - 10),
            new THREE.Vector3(x - 9, y + h - 10),
        ]);
        this.sldObjectsGroup.add(getLine([x - 4, Y - (h / 6) + 2.5], [X - (w / 4) - 7.33, Y - (h / 6) + 0.5]));
        this.sldObjectsGroup.add(getLine([x - 4, Y - (h / 6) + 2.5], [x - 4, y + h - 10]));
        ...
        this.redLines.push(
            ...
            new THREE.Vector3(X - gap, y + (5 * (h / 6)) - 7),
        );
        this.redPolyLines.push({
            points:[
                new THREE.Vector3(X - gap, y + (5 * (h / 6)) + 4),
        ...
        this.blueLines.push(
            new THREE.Vector3(X + gap, y + (5 * (h / 6)) + 38),
        ...
        // this.blueLines.push(
        //     new THREE.Vector3(x - 18, y + 28),
        //     new THREE.Vector3(x - 18, y + (h / 6) + 34),
        // );

        this.whiteCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 2, y + (5 * (h / 6)) + 0.66),
            radius: 4,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (w / 4) - 2, y + (5 * (h / 6)) + 0.66],
            radius: 4,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        }));
        ...
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 6, y + (5 * (h / 6))),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (w / 4) - 6, y + (5 * (h / 6))],
            radius: 0.33,
            startAngle: 0,
            endAngle: 2 * Math.PI,
        }));
        ...
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (w / 4) + 2, y + (5 * (h / 6))),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (w / 4) + 2, y + (5 * (h / 6))],
            radius: 0.33,
            startAngle: 0,
            endAngle: 2 * Math.PI,
        }));
        ...
        this.whiteLines.push(
            new THREE.Vector3(X - (w / 4) + 2.33, y + (5 * (h / 6))),
        ...
        this.redCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 2, y + (5 * (h / 6)) + 0.66 + gap),
            radius: 4,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        });
        this.s3ldObjectsGroup.add(getThreeArc(
            {
                origin: [X - (w / 4) - 2, y + (5 * (h / 6)) + 0.66 + gap],
                radius: 4,
                startAngle: Math.PI,
                endAngle: 2 * Math.PI,
            },
        ...
        this.redCircles.push({
            position: new THREE.Vector3(X - (w / 4) + 2, y + (5 * (h / 6)) + gap),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        ...
        this.redCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 6, y + (5 * (h / 6)) + gap),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        ...
        this.redLines.push(
            new THREE.Vector3(X - (w / 4) + 2.33, y + (5 * (h / 6)) + gap),
        ...
        this.dashedLines.push(
            new THREE.Vector3(x - 22, y + (h / 6) - 1),
        ...
        this.dashedLines.push(
            new THREE.Vector3(x - 22, y + 25),
            new THREE.Vector3(x + 41, y + 25),
        );
        this.dashedPolyLines.push({
            points:[
                new THREE.Vector3(x - 22, y + 25),
        ...
        this.texts.push({
            position: new THREE.Vector3(x - 22, y - 36),
            text: 'GROUNDING',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - 22, y - 44),
            text: '    SYSTEM',
            size: 7,
        });
