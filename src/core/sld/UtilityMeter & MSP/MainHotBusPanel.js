...
export default class TopFed {
    ...
    getLower(origin, sizes) {
        ...
        this.sldObjectsGroup.add(createTextElement(this.font, info, [x + w + 24, y + h - 4], 4));
        ...
        this.texts.push({
            position: new THREE.Vector3(x + w + 24, y + h - 12),
            text: 'HOT BUS PANEL',
            size: 7,
        });

        this.texts.push({
            position: new THREE.Vector3(x - w + 30 - textShiftFactorDxf, y + h - 10),
            text: `(N) ${placeHolder3} A PV BREAKER`,
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info2, [x - w + 10, y + h - 12], 4));

        this.texts.push({
            position: new THREE.Vector3(X - (w / 4), Y - (h / 6) + 7),
            text: `(N) ${placeHolder3} A`,
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info4, [X - (w / 4) - 1, Y - (h / 6) + 7], 4));
        this.leaders.push([
            new THREE.Vector3(X - (w / 4) - 7.33, Y - (h / 6) + 0.50),
            new THREE.Vector3(x - 4, Y - (h / 6) + 2.50),
            new THREE.Vector3(x - 4, y + h - 10),
            new THREE.Vector3(x - 9, y + h - 10),
        ]);
        this.sldObjectsGroup.add(getLine([X - (w / 4) - 7.33, Y - (h / 6) + 0.50], [x - 4, Y - (h / 6) + 2.50]));
        this.sldObjectsGroup.add(getLine([x - 4, Y - (h / 6) + 2.50], [x - 4, y + h - 10]));
        this.sldObjectsGroup.add(getLine([x - 9, y + h - 10], [x - 4, y + h - 10]));
        ...
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 3, Y + (2 * (h / 6)) + 0.66),
            radius: 4,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (w / 4) - 3, Y + (2 * (h / 6)) + 0.66],
            radius: 4,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        }));
        ...
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (w / 4) + 1, Y + (2 * (h / 6))),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (w / 4) + 1, Y + (2 * (h / 6))],
            radius: 0.33,
            startAngle: 0,
            endAngle: 2 * Math.PI,
        }));
        ...
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 7, Y + (2 * (h / 6))),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (w / 4) - 7, Y + (2 * (h / 6))],
            radius: 0.33,
            startAngle: 0,
            endAngle: 2 * Math.PI,
        }));
        ...
        this.whiteLines.push(
            new THREE.Vector3(X - (w / 4) + 1.33, Y + (2 * (h / 6))),
            new THREE.Vector3(X, Y + (2 * (h / 6))),
        );
        this.whitePolyLines.push({
            points:[
                new THREE.Vector3(X - (w / 4) + 1.33, Y + (2 * (h / 6))),
        ...
        this.redCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 3, Y + (2 * (h / 6)) + gap + 0.66),
            radius: 4,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        });
        this.s3ldObjectsGroup.add(getThreeArc(
            {
                origin: [X - (w / 4) - 3, Y + (2 * (h / 6)) + gap + 0.66],
                radius: 4,
                startAngle: Math.PI,
                endAngle: 2 * Math.PI,
            },
        ...
        this.redCircles.push({
            position: new THREE.Vector3(X - (w / 4) + 1, Y + (2 * (h / 6)) + gap),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        ...
        this.redCircles.push({
            position: new THREE.Vector3(X - (w / 4) - 7, Y + (2 * (h / 6)) + gap),
            radius: 0.33,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        ...
        this.redLines.push(
            new THREE.Vector3(X - (w / 4) + 1.33, Y + (2 * (h / 6)) + gap),
            new THREE.Vector3(X - gap, Y + (2 * (h / 6)) + gap),
        );
        this.redPolyLines.push({
            points:[
                new THREE.Vector3(X - (w / 4) + 1.33, Y + (2 * (h / 6)) + gap),
