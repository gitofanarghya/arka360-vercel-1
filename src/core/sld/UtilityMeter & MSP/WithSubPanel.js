...
export default class WithSubPanel {
    ...
    createComponent() {
        ...
        this.texts.push({
            position: new THREE.Vector3(this.originX + 29.5, (this.size * 3) + 32 - boxShiftY),
            text: 'BI-DIRECTIONAL',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(this.originX + 29.5, (this.size * 3) + 24 - boxShiftY),
            text: 'UTILITY METER',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(this.originX + 29.5, (this.size * 3) + 16 - boxShiftY),
            text: '  1-PHASE, 3-W,',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(this.originX + 29.5, (this.size * 3) + 8 - boxShiftY),
            text: '120V/240V, 60Hz',
            size: 7,
        });
    ...
    getLower(origin, sizes) {
        ...
        const info = `(${placeHolder}) ${placeHolder3} A MAIN SERVICE PANEL\nWITH (${placeHolder}) ${placeHolder3} A MAIN BREAKER\n                                   (TOP FED)`;
        const conduit = `(3) #8 AWG THWN${thwnNumber}\n(1) #8 AWG THWN${thwnNumber} GND\nIN 3/4" EMT CONDUIT RUN`;
        const subInfo = `${placeHolder3} A SUB PANEL`;
        const points1 = [];
        points1.push(...getThreeEllipse([x - 15, y + 35]));
        for (let i = 0; i < points1.length - 1; i++) {
            this.whiteLines.push(
                new THREE.Vector3(points1[i].x, points1[i].y),
                new THREE.Vector3(points1[i + 1].x, points1[i + 1].y),
            );
        }
        this.whiteLines.push(
            new THREE.Vector3(x - 15, y + 10),
            new THREE.Vector3(x - 15, y + 10 - (50 / 1.5)),
        );
        this.whitePolyLines.push({
            points:[
                new THREE.Vector3(x - 15, y + 10),
        ...
        this.texts.push({
            position: new THREE.Vector3(x - w + 10, y + h + 60),
            text: `(${placeHolder}) ${placeHolder3} A MAIN SERVICE PANEL`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w + 10, y + h + 52),
            text: `WITH (${placeHolder}) ${placeHolder3} A MAIN BREAKER`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w + 10, y + h + 44),
            text: '                                   (TOP FED)',
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info, [x - w + 10, y + h + 60], 4));
        this.leaders.push([
            new THREE.Vector3(X - 3, y + (5 * (h / 6))),
            new THREE.Vector3(x - 4, y + (5 * (h / 6))),
            new THREE.Vector3(x - 4, y + h + 65),
            new THREE.Vector3(x - 9, y + h + 65),
        ]);
        this.sldObjectsGroup.add(getLine([X - 3, y + (5 * (h / 6))], [x - 4, y + (5 * (h / 6))]));
        this.sldObjectsGroup.add(getLine([x - 4, y + (5 * (h / 6))], [x - 4, y + h + 65]));
        this.sldObjectsGroup.add(getLine([x - 4, y + h + 65], [x - 9, y + h + 65]));
        ...
        this.texts.push({
            position: new THREE.Vector3(x, y - 42),
            text: `(3) #8 AWG THWN${thwnNumber}`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x, y - 42 - 8),
            text: `(1) #8 AWG THWN${thwnNumber} GND`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x, y - 42 - 16),
            text: 'IN 3/4" EMT CONDUIT RUN',
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, conduit, [x, y - 42], 4));
        ...
        this.texts.push({
            position: new THREE.Vector3(x - w - 72, y + h),
        ...
        this.sldObjectsGroup.add(getLine([X - (w / 4) - 97.33, Y - (h / 6) + 0.5], [x - 94, Y - (h / 6) + 0.5 + 10]));
        ...
        this.texts.push({
            position: new THREE.Vector3(x - 78, y - 22 + 30),
            text: '   EXISTING',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - 78, y - 22 - 8 + 30),
            text: 'GROUNDING',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - 78, y - 22 - 16 + 30),
            text: '    SYSTEM',
            size: 7,
        });
