...
export default class TopFed {
    ...
    getLower(origin, sizes) {
        ...
        this.sldObjectsGroup.add(getLine([x - 4, y + h + 2], [x - 9, y + h + 2]));
        ...
        this.sldObjectsGroup.add(createTextElement(this.font, 'LOAD SIDE TAP', [x + w + 30, y + h - 5], 4));
        this.leaders.push([
            new THREE.Vector3(X + 1, Y + (h / 6)),
            new THREE.Vector3(x + w, y + h - 5),
            new THREE.Vector3(x + w + 10, y + h - 5),
        ]);
        this.sldObjectsGroup.add(getLine([X + 1, Y + (h / 6)], [x + w, y + h - 5]));
        ...
        this.redLines.push(
            new THREE.Vector3(x - 14, Y + (h / 6) + gap),
            new THREE.Vector3(X - gap, Y + (h / 6) + gap),
        );
        this.redPolyLines.push({
            points:[
