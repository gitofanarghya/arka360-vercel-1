...
export default class SolarReadyPanel {
    ...
    getLower(origin, sizes) {
        ...
        this.texts.push({
            position: new THREE.Vector3(x + w + 4 + 20, y + h - 4),
            text: `(${placeHolder}) ${placeHolder3} A MAIN`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x + w + 5 + 20, y + h - 12),
            text: 'SERVICE PANEL',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x + w + 11 + 20, y + h - 20),
            text: `WITH (${placeHolder}) ${placeHolder3} A MAIN`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x + w + 4 + 20, y + h - 28),
            text: ' BREAKER WITH',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x + w + 5 + 20, y + h - 36),
            text: '100A AUXILIARY',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x + w + 6 + 20, y + h - 44),
            text: ' BREAKER (SOLAR',
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x + w + 4 + 20, y + h - 52),
            text: 'READY PANEL)',
            size: 7,
        });
        ...
        this.texts.push({
            position: new THREE.Vector3(x - w + 35 - textShiftFactorDxf, y + h + 10),
            text: `(${placeHolder}) ${placeHolder3} A MAIN`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w + 35 - textShiftFactorDxf, y + h + 18),
            text: 'BREAKER 240V/2P',
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info4, [x - w + 25, y + h + 10], 4));
        this.leaders.push([
            new THREE.Vector3(X - 3, y + (5 * (h / 6))),
            new THREE.Vector3(x - 4, y + (5 * (h / 6))),
            new THREE.Vector3(x - 4, y + h + 10),
            new THREE.Vector3(x - 9, y + h + 10),
        ]);
        this.sldObjectsGroup.add(getLine([x - 4, y + (5 * (h / 6))], [X - 3, y + (5 * (h / 6))]));
        this.sldObjectsGroup.add(getLine([x - 4, y + (5 * (h / 6))], [x - 4, y + h + 10]));
        this.sldObjectsGroup.add(getLine([x - 4, y + h + 10], [x - 9, y + h + 10]));
        this.texts.push({
        ...
        this.texts.push({
            position: new THREE.Vector3(x - w + 25 - textShiftFactorDxf, y + h + 40),
            text: `(N) ${placeHolder2} A/2P DEDICATED`,
            size: 7,
        });
        this.texts.push({
            position: new THREE.Vector3(x - w + 25 - textShiftFactorDxf, y + h + 40 - 8),
            text: '                 PV BREAKER',
            size: 7,
        });
        this.sldObjectsGroup.add(createTextElement(this.font, info2, [x - w + 10, y + h + 40], 4));

        this.leaders.push([
            new THREE.Vector3(X - (3 * gap) - 1, y + (5 * (h / 6)) + 6 + 1 + 0.5),
            new THREE.Vector3(x - 4, y + h + 40),
            new THREE.Vector3(x - 9, y + h + 40),
        ]);
        this.sldObjectsGroup.add(getLine([x - 4, y + h + 40], [X - (3 * gap) - 1, y + (5 * (h / 6)) + 6 + 1 + 0.5]));
        this.sldObjectsGroup.add(getLine([x - 4, y + h + 40], [x - 9, y + h + 40]));
        // Start Points
        this.startPoints = [{
            red: [x - 8, y + (5 * (h / 6)) + 6 + gap],
            white: [x, y + (5 * (h / 6)) + 6],
            blue: [x - 14, y + 28],
        ...
        // side connections
        this.whiteLines.push(
            new THREE.Vector3(X - (2 * gap), y + (5 * (h / 6)) + 6),
            new THREE.Vector3(X - (2 * gap), (y + h)),
        );
        this.whitePolyLines.push({
            points:[
                new THREE.Vector3(X - (2 * gap), y + (5 * (h / 6)) + 6),
        ...
        this.redLines.push(
            new THREE.Vector3(X - (3 * gap) + 2, y + (5 * (h / 6)) + 6 + gap),
            new THREE.Vector3(X - (3 * gap) + 2, (y + h)),
        );
        this.redPolyLines.push({
            points:[
                new THREE.Vector3(X - (3 * gap) + 2, y + (5 * (h / 6)) + 6 + gap),
        ...
        this.redLines.push(
            new THREE.Vector3(X - (3 * gap) + 2, y + (5 * (h / 6)) + 6 + gap),
            new THREE.Vector3(X - (3 * gap) + 0.16, y + (5 * (h / 6)) + 6 + gap),
        );
        this.redPolyLines.push({
            points:[
                new THREE.Vector3(X - (3 * gap) + 2, y + (5 * (h / 6)) + 6 + gap),
        ...
        this.whiteLines.push(
            new THREE.Vector3(X - (2 * gap), y + (5 * (h / 6)) + 6),
            new THREE.Vector3(X - (3 * gap) + 0.16, y + (5 * (h / 6)) + 6),
        );    
        this.whitePolyLines.push({
            points:[
                new THREE.Vector3(X - (2 * gap), y + (5 * (h / 6)) + 6),
        ...
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (3 * gap) - 2, y + (5 * (h / 6)) + 6.33),
            radius: 2,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (3 * gap) - 2, y + (5 * (h / 6)) + 6.33], radius: 2, startAngle: Math.PI, endAngle: 2 * Math.PI,
        }));

        this.whiteCircles.push({
            position: new THREE.Vector3(X - (3 * gap) - 4, y + (5 * (h / 6)) + 6),
            radius: 0.16,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (3 * gap) - 4, y + (5 * (h / 6)) + 6], radius: 0.16, startAngle: 0, endAngle: 2 * Math.PI,
        }));
        this.whiteCircles.push({
            position: new THREE.Vector3(X - (3 * gap), y + (5 * (h / 6)) + 6),
            radius: 0.16,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.sldObjectsGroup.add(getThreeArc({
            origin: [X - (3 * gap), y + (5 * (h / 6)) + 6], radius: 0.16, startAngle: 0, endAngle: 2 * Math.PI,
        })); // main wire curve

        this.redCircles.push({
            position: new THREE.Vector3(X - (3 * gap) - 2, y + (5 * (h / 6)) + 6 + gap + 0.33),
            radius: 2,
            startAngle: Math.PI,
            endAngle: 2 * Math.PI,
        });
        this.s3ldObjectsGroup.add(getThreeArc({
            origin: [X - (3 * gap) - 2, y + (5 * (h / 6)) + 6 + gap + 0.33], radius: 2, startAngle: Math.PI, endAngle: 2 * Math.PI,
        }, 'red'));

        this.redCircles.push({
            position: new THREE.Vector3(X - (3 * gap) - 4, y + (5 * (h / 6)) + 6 + gap),
            radius: 0.16,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.s3ldObjectsGroup.add(getThreeArc({
            origin: [X - (3 * gap) - 4, y + (5 * (h / 6)) + 6 + gap], radius: 0.16, startAngle: 0, endAngle: 2 * Math.PI,
        }, 'red'));

        this.redCircles.push({
            position: new THREE.Vector3(X - (3 * gap), y + (5 * (h / 6)) + 6 + gap),
            radius: 0.16,
            startAngle: 2 * Math.PI,
            endAngle: 0,
        });
        this.s3ldObjectsGroup.add(getThreeArc({
            origin: [X - (3 * gap), y + (5 * (h / 6)) + 6 + gap], radius: 0.16, startAngle: 0, endAngle: 2 * Math.PI,
        }, 'red')); // red curve

        this.whiteLines.push(
            new THREE.Vector3(X - (3 * gap) - 4.16, y + (5 * (h / 6)) + 6),
            new THREE.Vector3(x, y + (5 * (h / 6)) + 6),
        );
        this.whitePolyLines.push({
            points:[
        ...
        this.redLines.push(
            new THREE.Vector3(X - (3 * gap) - 4.16, y + (5 * (h / 6)) + 6 + gap),
            new THREE.Vector3(x - 8, y + (5 * (h / 6)) + 6 + gap),
        );
        this.redPolyLines.push({
            points:[
                new THREE.Vector3(X - (3 * gap) - 4.16, y + (5 * (h / 6)) + 6 + gap),
        ...
        //     new THREE.Vector3(X - gap, y + (5 * (h / 6)) + 2.33),
        // );
