    ...
    <div
        ...
        >
            <form
                ...
                action="#">
                <div  style = "padding-top:20px;" class="filter-div-light center-space-between-alignment">
                    <div style="width: 45%;">
            ...
            <el-option-group
                style = "margin-top: 10px; min-width:750px !important;"
    ...
    methods: {
        ...
        async fetchMasterDataInverters() {
            try {
                ...
                const response = await API.MASTER_DATA_INVERTER.FETCH_MASTER_INVERTERS_BY_TYPE(this.inverterType);
        ...
        async searchMasterInvertersHelper(query) {
            try {
                this.loading = true;
                const response = await API.MASTER_DATA_INVERTER.SEARCH_MASTER_INVERTERS(query, this.isAdminPanel);
