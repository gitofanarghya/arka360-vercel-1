<template>
    <div id="inverterForm">
        <VuePerfectScrollbar class="scroll-area">
            <el-form
                :model="profileData.drawing_defaults.inverter"
                ...
                <el-form-item label="Azimuth">
                    <input
                        ...
                        v-model.number="profileData.drawing_defaults.inverter.azimuth"
                        type="number"
                ...
                <el-form-item label="Mount Height">
                    <input-length
                        v-model="profileData.drawing_defaults.inverter.mountHeight"
                        :name="'Mount Height'"
...
export default {
    ...
    props: ['profileData', 'profileData.drawing_defaults.inverter'],
    data() {
        return {
            labelPosition: 'left',
            inverterProp: {
...
#inverterForm  .el-form-item__label {
    text-align: left;
...
color: red;}
#inverterForm >>> .el-form-item--mini.el-form-item {
    margin-bottom: 1px;
}#inverterForm >>> .el-form-item--mini .el-form-item__content {
    line-height: 28px;
    margin-top: 5px;
}
</style>
