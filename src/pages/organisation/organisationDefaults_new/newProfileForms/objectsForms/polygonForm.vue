<template>
    <div id="polygonForm">
        <VuePerfectScrollbar class="scroll-area">
            ...
            <el-form
                :model="profileData.drawing_defaults.polygonModel"
                ...
                <el-form-item label="Base Height">
                    <img
                        :class="[profileData.drawing_defaults.polygonModel.lockedParameter ===
                    ...
                    >
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.coreHeight"
                        :name="'Base Height'"
                        :disabled="profileData.drawing_defaults.polygonModel.lockedParameter === lockConstants.CORE_HEIGHT_LOCKED"
                        :metric-validation="{
                            required: profileData.drawing_defaults.polygonModel.lockedParameter !==
                ...
                <el-form-item label="Top Height">
                    ...
                    >
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.topHeight"
                        :name="'Top Height'"
                        :disabled="profileData.drawing_defaults.polygonModel.lockedParameter === lockConstants.TOP_HEIGHT_LOCKED"
                        :metric-validation="{
                            required: profileData.drawing_defaults.polygonModel.lockedParameter !==
                ...
                <el-form-item label="Tilt">
                    ...
                    <input
                        ...
                        v-model.number="profileData.drawing_defaults.polygonModel.tilt"
                        :disabled="profileData.drawing_defaults.polygonModel.lockedParameter ===
                        lockConstants.TILT_LOCKED"
                        type="number"
                ...
                <el-form-item label="Azimuth">
                    <input
                        ...
                        v-model.number="profileData.drawing_defaults.polygonModel.azimuth"
                        type="number"
                        class="inputBoxStyler"
                        autocomplete="off"
                        name="Azimuth"
                ...
                <el-form-item label="Parapet Height">
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.parapetHeight"
                        :name="'Parapet Height'"
                ...
                <el-form-item label="Parapet Thickness">
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.parapetThickness"
                ...
                <el-form-item label="Setback Inside">
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.setbackInside"
                        :name="'Setback Inside'"
                ...
                <el-form-item label="Setback Outside">
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.setbackOutside"
                ...
                <el-form-item label="Irradiance Map Threshold">
                    <input-length
                        v-model="profileData.drawing_defaults.polygonModel.heatMapThreshold"
                ...
                <el-form-item label="Ignored">
                    <div style="width:90%">
                        <el-switch v-model="profileData.drawing_defaults.polygonModel.ignored"/>
                    </div>
                </el-form-item>
            </el-form>
        </VuePerfectScrollbar>
...
export default {
    ...
    methods: {
        lockParameter(parameterName) {
            if (this.profileData.drawing_defaults.polygonModel.lockedParameter !== parameterName) {
                this.profileData.drawing_defaults.polygonModel.lockedParameter = parameterName;
                switch (parameterName) {
                case TOP_HEIGHT_LOCKED: this.profileData.drawing_defaults.polygonModel.topHeight = '';
                    break;
                case CORE_HEIGHT_LOCKED: this.profileData.drawing_defaults.polygonModel.coreHeight = '';
                    break;
                case TILT_LOCKED: this.profileData.drawing_defaults.polygonModel.tilt = '';
                    break;
                default:
                    console.error(`ERROR: PolygonForm: lockParameter failed -
...
#polygonForm >>> .el-form-item__label {
    text-align: left;
...
color: red;}
#polygonForm >>> .el-form-item--mini.el-form-item {
    margin-bottom: 1px;
}
#polygonForm >>> .el-form-item--mini .el-form-item__content {
    line-height: 28px;
    margin-top: 5px;
}
</style>
