<template>
    <div class='deleteModule'>
        <el-dialog 
            :visible="isDeleteFaqPopupVisible"
        ...
        >
            ...
            <p class='msg'>Are you sure you want to delete this FAQ?</p>
            <div class='button_container'>
                <el-button type="primary" :loading=isLoading @click="deleteFaq()">Yes</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        async deleteFaq() {
            ...
            let frequentlyAskedQuestions = this.frequentlyAskedQuestions;
            frequentlyAskedQuestions.splice(this.index, 1);
            const patchData = { frequently_asked_questions : frequentlyAskedQuestions };
            if(this.ISUs){
