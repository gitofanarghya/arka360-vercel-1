        ...
        <div
            ...
            <div class="dataProperties scroll-subarray">
                ...
                <div
                    ...
                    <el-tooltip 
                        placement="top"
                        content="Generation might get slow if you choose bifacial"
                ...
                <div class="sappane-label sappane-label-panel" style="display: flex; justify-content: space-between;">
                    <div style="display: flex; justify-content: flex-start;">
                        ...
                        placement="top" popper-class="designStudioToolTip">
                            ...
                            <template #content>Solar Module template are of two types i.e.,<br />Tilted Mount and Roof Mount. Tilted Mount<br/>solar modules are installed directly onto a<br/>surface for a streamlined appearance, while<br/>Roof Mount solar panels are installed at an <br/>angle to optimize sunlight capture.</template>
                ...
                <div
                    v-if="CONSTANTS.STRUCTURE_TYPES.includes(structureType) || eastWestRackingEnabled"
                    class="sappane-label">
                    Tilt
                    <span>
                        <label>
                ...
                <!-- <div class="sappane-label" v-if="eastWestRackingEnabled && this.mountType === this.CONSTANTS.SUBARRAY_RACK_STYLE_EWRACKING">
                    Intra Row Spacing
                    <el-tooltip
                        placement="top" popper-class="designStudioToolTip">
                ...
                <!-- <div
                    v-if="eastWestRackingEnabled && this.mountType === this.CONSTANTS.SUBARRAY_RACK_STYLE_EWRACKING"
                ...
                <div class="sappane-label" v-if="eastWestRackingEnabled && this.mountType === this.CONSTANTS.SUBARRAY_RACK_STYLE_EWRACKING">
                    ...
                    <p>
                        <span>{{ errors.first('Inter Row Spacing') }}</span>
                    </p>
                </div> -->
                <!-- Temporary fix for EW -->
                <!-- <div
                v-if="eastWestRackingEnabled && this.mountType === this.CONSTANTS.SUBARRAY_RACK_STYLE_EWRACKING"
                id="rowSpacingModeToggle"
                class="sappane-label sappane-radio-wrapper">
                    Inter Row Spacing Mode
                    <el-radio-group v-model="rowSpacingMode">
                        <el-radio-button
                            :disabled="!editEnabled"
                            :label="CONSTANTS.ROW_SPACING_MODE_AUTO"/>
                        <el-radio-button
                ...
                v-if="eastWestRackingEnabled && this.mountType === this.CONSTANTS.SUBARRAY_RACK_STYLE_EWRACKING">
                    ...
                    <input-length
                        v-model="rowSpacing"
                        :name="'Row Spacing'"
                        :disabled="!editEnabled || autoRowSpacingMode"
                        :metric-validation="lengthValidation"
                        :class-input="'sappane-input-value'"
                    />
                    <p>
                    ...
                    <div
                        ...
                        <div style="display: flex; justify-content: flex-start;">
                            ...
                            placement="top" popper-class="designStudioToolTip">
                                ...
                                <template #content>The mount height of solar module is the<br/>distance between its bottom edge and the
                ...
                <div
                    v-if="!flushMountMode && !eastWestRackingEnabled"
                    id="rowSpacingModeToggle"
                    class="sappane-label sappane-radio-wrapper">
                    Row Spacing Mode
                    <el-radio-group v-model="rowSpacingMode">
...
export default {
    ...
    data() {
        return {
            ...
            rowSpacingMode: this.propertiesData.rowSpacingMode,
            rowSpacing: this.propertiesData.rowSpacing,
    ...
    computed: {
        ...
        autoRowSpacingMode() {
            return this.rowSpacingMode === this.CONSTANTS.ROW_SPACING_MODE_AUTO;
        },
    ...
    watch: {
        ...
        mountType(newVal) {
            ...
            if (newVal === this.CONSTANTS.SUBARRAY_RACK_STYLE_EWRACKING){
                ...
                this.propertiesData.ewRackCreated();
            }
            ...
            // } 
            this.rowSpacingMode =
                propertiesData.rowSpacingMode !== undefined
                    ? propertiesData.rowSpacingMode
                    : this.propertiesData.rowSpacingMode;
            this.rowSpacing =
                propertiesData.rowSpacing !== undefined
                    ? propertiesData.rowSpacing
                    : this.propertiesData.rowSpacing;
        ...
        structureType(newVal) {
            if (newVal !== undefined) {
                ...
                if (dynamicSubarrayProperties.rowSpacingMode !== this.rowSpacingMode && this.rowSpacingMode !== null) {
                    dynamicSubarrayProperties.rowSpacingMode = this.rowSpacingMode;
                }
                ...
                if (subarrayProperties.rowSpacingMode
                    && subarrayProperties.rowSpacingMode !== null) {
                    this.rowSpacingMode = subarrayProperties.rowSpacingMode;
                }
                if (subarrayProperties.rowSpacing && subarrayProperties.rowSpacing !== null) {
                    this.rowSpacing = subarrayProperties.rowSpacing;
                }
    ...
    mounted() {
        ...
        this.$watch(
            () => ({
                ...
                rowSpacingMode: vm.rowSpacingMode,
            }),
            () => {
                this.$validator.validate().then(() => {
                    if (
                        !this.errors.any() &&
                        this.rowSpacingMode === this.CONSTANTS.ROW_SPACING_MODE_AUTO &&
                    ...
                    this.$validator.validate().then(() => {
                        ...
                        if (this.creationMode) {
                            ...
                            if (Object.keys(preVal.selectedPanel).length !== 0 && preVal.selectedPanel !== newVal.selectedPanel) {
                                ...
                                (preVal.rowSpacing !== newVal.rowSpacing) ||
                                ...
                                (preVal.rowSpacingMode !== newVal.rowSpacingMode) ||
                        ...
                        if (
                            ...
                            vm.rowSpacing !== vm.propertiesData.rowSpacing ||
                            ...
                            vm.rowSpacingMode !== vm.propertiesData.rowSpacingMode ||
    ...
    methods: {
        ...
        resetProperties() {
            ...
            this.rowSpacing = this.propertiesData.rowSpacing;
            this.rowSpacingMode = this.propertiesData.rowSpacingMode;
        ...
        updateRowSpacing() {
            ...
            this.rowSpacing = this.propertiesData.getOptimisedRowSpacing(params);
