        ...
        <div class="scroll-area" v-bar>
            <div class="data-summary">
                ...
                <p  v-show="creationMode" 
                    class="sappane-label"> Current Module Count <span class="sappane-value" :class="{warn: (totalPanelCount != currentPanelsCount)}" > {{ currentPanelsCount }} </span></p>
                <p  v-show="creationMode" 
                    class="sappane-label"> Set Module Count <span class="sappane-value"> {{ totalPanelCount }} </span></p>
                <p
                    v-show="!creationMode"
                    class="sappane-label"> Modules <span class="sappane-value"> {{ numPanels }} </span></p>
                <p
                    v-show="!creationMode"
