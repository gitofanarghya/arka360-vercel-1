  ...
  <div class="deleteModule">
    ...
    >
      ...
      <div class="alert">
        ...
        <p  class="msg">
          {{errorMessageInPopup}}
          <!-- Kindly Add utility rates and utility Provider first! -->
        </p>
      <div class="button_container">
        <button class="btn primary confirmButton" @click="redirectToDesignSummary()">
          Ok
        </button>
      </div>
    </el-dialog>
...
export default {
  ...
  props: {
    ...
    errorMessageInPopup:{
      type: String,
      default:'Error! Pls try once again!',
    }
