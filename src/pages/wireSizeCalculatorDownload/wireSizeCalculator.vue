          ...
          <!-- replica of above table for now when differentTypeInverter is true-->
            <div v-if="parseInt(inverterSpecs[0].no_of_inverters)>0 && inverterSpecs[0].type !=='Micro Inverter' " >
             <div v-for="i in parseInt(inverterSpecs[0].no_of_inverters)-1" :key="i">
                ...
                <div  class = "togglebuttonClass " :class="{applyPageBreak: (inverterSpecs[0].no_of_inverters>=2 && differentTypeInverter)}" >
            ...
            <el-col :span="9" style="font-size:11px;">
               <div class = "togglebuttonClass" style="margin-top:0px">
                ...
                <calculationTable
                    ...
                    @tag-id-from-table="saveTagIdFromTable"
                />
                <div class = "togglebuttonClass" :class="{tableno7: (showtableheader4 && showtableheader6 && showtableheader7) }">
...
@media print {
  ...
  .applyPageBreak {page-break-before: always;}
