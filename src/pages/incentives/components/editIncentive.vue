<template>
  <div id="editIncentiveDialog">
    ...
    >
      <el-form v-loading="!isEditDataLoaded">
        <div
...
export default {
  ...
  methods: {
    ...
    onCountryChange(countryId) {
      ...
      this.countryCode = chosenCountryDetails.id; 
    ...
    async updateIncentive() {
      ...
      try {
        const response = await API.INCENTIVE_INFORMATION.UPDATE_INCENTIVE(
          this.incentive_id,
          postData
        );
...
#editIncentiveDialog >>> .el-select {
  display: inline-block;
  position: relative;
  width: -webkit-fill-available;
}

#editIncentiveDialog >>> .el-dialog__footer {
  text-align: center !important;
  margin-top: 0 !important;
}

#editIncentiveDialog >>> .el-dialog {
  width: 52vh;
  border-radius: 8px;
}

#editIncentiveDialog >>> .el-dialog__header {
...
#editIncentiveDialog >>> .floating-label label {
...
#editIncentiveDialog >>> .el-dialog__title {
...
#editIncentiveDialog >>> .btn.btn-primary:disabled,
.btn.btn-primary.disabled {
  background-image: linear-gradient(to bottom, #f1f1f1, #ddd);
}

#editIncentiveDialog >>> .el-input--suffix .el-input__inner {
...
#editIncentiveDialog >>> .el-input--suffix .el-input__inner::placeholder {
  color: #222 !important;
}

#editIncentiveDialog  >>> .el-select .el-input .el-select__caret { 
...
#editIncentiveDialog >>> .el-select > .el-input {
  display: block;
  color: #222;
  font-size: 16px;
  /* padding: 10px 16px; */
...
#editIncentiveDialog >>> .floating-label {
  margin-bottom: 40px !important;
}

#editIncentiveDialog >>> .currencySymbols {
  font-size: 16px !important;
  color: #222 !important;
}

#editIncentiveDialog >>> .floating-input {
  color: #222;
  font-size: 16px;
  padding: 10px 16px;
  padding-right: 27px;
...
#editIncentiveDialog >>> .el-dialog__wrapper {
  overflow: hidden !important;
  top: -18px !important;
  max-height: 93vh !important;
}
#editIncentiveDialog >>> .btn.btn-primary {
  height: 3rem;
  width: 11rem;
  font-size: 16px !important;
...
#editIncentiveDialog >>> .el-dialog__close {
  color: #222222 !important;
  font-weight: 800 !important;
  font-size: 18px !important;
}

#editIncentiveDialog >>> .el-checkbox__input {
  position: relative !important;
  right: -3%;
  top: -5px;
}

#editIncentiveDialog >>> .el-checkbox__label {
  font-family: "Helvetica Neue";
  position: relative;
  font-size: 16px;
  font-weight: 100;
...
#editIncentiveDialog >>> #currencySelect {
  width: auto;
}

#editIncentiveDialog >>> .el-checkbox:last-child {
  display: flex;
  flex-direction: row-reverse;
  margin-left: 1.5rem;
}

#editIncentiveDialog >>> .el-dialog__body {
  max-height: 67vh;
  overflow: scroll;
  padding-top: 44px !important;
}

#editIncentiveDialog >>> .floating-label.right_value .value_area {
  font-size: 16px !important;
}

#editIncentiveDialog >>> .el-checkbox__inner {
  position: relative;
  border-radius: 2px;
