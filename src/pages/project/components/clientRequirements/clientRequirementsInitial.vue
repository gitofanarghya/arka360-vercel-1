    ...
    <div id="clientRequirement">
            ...
            <div class="card">
              ...
              <div class="card_content">
                <!-- <h6>Select an option to input current energy usage and bills</h6> -->
             <router-link :to="'/projectSummary/consumptionProfile/' + projectId">
                <el-button
                    type="primary"
                    class="addConsumBtn"
...
<style scoped>
#clientRequirement  >>>    .addConsumBtn {
       font-size: 16px;
       font-weight: 600;
}
