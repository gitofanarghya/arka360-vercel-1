<template>
                 <div v-if="activePage==='bom'" class="tab_content" id="tab2">
                     <button @click="redirectToDetailedBOMDownload()" class="downloadPDF" >Download PDF</button>
                                ...
                                <div class="row">
                                    <div class="col col-4">
                                        <div class="input_area">
                                            ...
                                            <input type="text" class="noprint cursorClass" v-model="customerOrderDetails.title" disabled id="title" />
                                        </div>
                                    ...
                                    <div class="col col-4">
                                        <div class="input_area">
                                            ...
                                            <input type="text" class="noprint cursorClass" v-model="customerOrderDetails.projectName" disabled id="projectName" />
                                        </div>
                                    </div>
                                    <div class="col col-4">
                                        <div class="input_area">
                                            <label> Project Location</label>
                                            <input type="text" class="noprint cursorClass" disabled v-model="customerOrderDetails.location" id="location" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col col-4">
                                        <div class="input_area">
                                            ...
                                            <input type="text" class="noprint cursorClass" disabled v-model="customerOrderDetails.customerName" id="customerName"/>
                                        </div>
                                    </div>
                                    <div class="col col-4">
                                        <div class="input_area">
                                            <label>Created By</label>
                                            <input type="text" class="noprint cursorClass" v-model="customerOrderDetails.projectManager" disabled id="projectManager" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col col-4">
                                        <div class="input_area">
                                            ...
                                            <input type="text" class="noprint cursorClass" v-model="customerOrderDetails.systemCapacityWp"
                                             id="systemCapacityWp" disabled/>
                                        </div>
                                    </div>
                                    <!-- <div class="col col-4">
                                        <div class="input_area">
                                            <label>Sales Person Name</label>
                                            <input type="text" disabled class="noprint cursorClass" v-model="customerOrderDetails.salesPerson"  id="salesPerson"/>
                                        </div>
                                    </div> -->
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col col-4">
                                        <div class="input_area">
                                            ...
                                            <input type="text" class="noprint cursorClass" v-model="createdAt"
                                             id="systemCapacityWp" disabled/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table>
                                        ...
                                        <tbody v-for="(keyName,index) in currentRoofKeyArray" :key="index">
                                            <tr v-if="currentRoof[keyName].length">
                                                <th colspan="7" v-if="(roleForTATA==='CP' || (roleForTATA!=='CP' && !balanceOfSupplyCheck ))
                                                 && keyName!=='Installation Kit' && keyName!=='Lightning Arrester and Earthing' && keyName!=='AC Cables'
                                                 && keyName!=='Ceig Charges' && keyName!=='Freight Charges'
                                                 && keyName!=='Service IC' && keyName!=='ITB'">
                                                    {{keyName}}
                                                </th>
                                                <th colspan="7" v-if="(roleForTATA!=='CP' && balanceOfSupplyCheck)">
                                                  {{keyName}}
                                                </th>
                                                <!-- <th colspan="7" v-if="!(roleForTATA==='CP')">{{keyName}}</th> -->
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr v-for="(item,index) in incomingCustomItemArray" :key="index">
                                                <td v-show="editBOQRowData.index !== index">
                                                    <strong>{{item.category}}</strong>
                                                </td>
                                                <td v-show="editBOQRowData.index === index">
                                                    <div class="input_area">
                                                        <label>Category</label>
                                                        <input type="text" v-model="editBOQRowData.category" />
                                                    </div>
                                                </td>
                                                <td v-show="editBOQRowData.index !== index" v-if="roleForTATA==='ADMIN'">
                                                    -
                                                    <!-- {{item.partNumber}} -->
                                                </td>
                                                <td v-show="editBOQRowData.index !== index" v-else></td>
                                                

                                                <td v-show="editBOQRowData.index === index">
                                                    <div class="input_area">
                                                        <!-- <label>Part Number</label>
                                                        <input type="text" v-model="editBOQRowData.partNumber" /> -->
                                                    </div>
                                                </td>

                                                <!-- <td v-show="editBOQRowData.index === index"></td> -->
                                                ...
                                                <td v-show="editBOQRowData.index === index">
                                                    <div class="input_area">
                                                        ...
                                                        <textarea type="text" v-model="editBOQRowData.description" />
                                                    </div>
                                                </td>
                                                ...
                                                <td v-show="editBOQRowData.index === index">
                                                    <div class="input_area">
                                                        <label>UOM</label>
                                                        <input type="text" v-model="editBOQRowData.uom" />
                                                    </div>
                                                </td>
                                                <td v-show="editBOQRowData.index !== index">
                                                    {{item.qty}}
                                                ...
                                                <td v-show="editBOQRowData.index === index">
                                                    <div class="input_area">
                                                        <label>QTY</label>
                                                        <input type="number" v-model="editBOQRowData.qty" />
                                                    </div>
                                                </td>
                                                <td v-show="editBOQRowData.index !== index">
                                                    {{item.price}}
                                                ...
                                                <td v-show="editBOQRowData.index === index">
                                                    <div class="input_area">
                                                        <label>Price</label>
                                                        <input type="number" v-model="editBOQRowData.price" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <ul style="display:flex;">
                                                        <li
                                                            v-show="editBOQRowData.index !== index"
                                                            @click="onEditBOQRowCategory(index, item.category, item.partNumber, item.description, item.uom, item.qty,item.price)"
                                                            class="setCursor">
                                                            <span class="el-icon-edit" ></span>
                                                        </li>
                                                        <li
                                                            v-show="editBOQRowData.index === index"
                                                            @click="onConfirmBOQRowEdit(index)"
                                                            class="setCursor">   
                                                         <span class="el-icon-check" ></span>   
                                                        </li>
                                                        <li 
                                                        style="margin-left:8px"
                                                        @click="onDeleteBOQRow(index)"
                                                        class="setCursor">
                                        ...
                                        <tbody v-if="showAddCustomItem">
                                            <tr class="add_tr_items">
                                                ...
                                                <td>
                                                    <div class="input_area">
                                                        <label>QTY</label>
                                                        <input type="number" v-model="customItem.qty" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input_area">
...
export default {
    ...
    methods:{
            ...
            redirectToDetailedBOMDownload(){
            let routeData = this.$router.resolve({name: 'detailedBOMDownload', params: {designId: this.designId}});
            ...
            async fetchBOMInformation(){
                try{
                    ...
                    // this.currentRoof = JSON.parse(JSON.stringify(this.roofs[1]))
            ...
            initializeCustomerOrderDetails(){
                ...
                this.customerOrderDetailsTemp.customerName = this.bomData.data.billOfMaterial.customerOrderDetails["customerName"];
