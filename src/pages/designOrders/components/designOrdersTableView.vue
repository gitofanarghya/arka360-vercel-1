      ...
      <div class="table_scroll">
        <div class="container-body">
          ...
          >
            ...
            <el-table-column v-if="buttonsData" width="180" :label="'Actions'">
              <template slot-scope="scope">
                <span class="btn_container" v-for="(btn, btnindex) in buttonsData" :key="btnindex" >
                  <el-tooltip
                    v-if="
            ...
            <div slot="append" class="empty_container" v-if="data.length=='0'" :style="{height:containerHeight}">
  <NoDataOverlay />
</div>
                    ...
                    <ul class="action_list">
                      ...
                      >
                        <el-tooltip
                          ...
                          :content="btn.tooltipContent"
                          v-if="
                      (item.design && btn.exist === 'desgin') ||
                      (item.additional_info?.path &&
                        btn.exist === 'survey')
                    "
                        >
                          <!-- RKChange2 +comment-->
                          ...
                          <el-button
                            ...
                            :icon="btn.icon"
                            :size="btn.size"
                            @click.native.stop="btn.callback(item)"
                          ></el-button>
                          <!-- end -->
                        </el-tooltip>
