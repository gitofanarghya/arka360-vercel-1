<template>
  <div class="deleteModule">
    <el-dialog
      :visible="isDeletePriceingPopupOpen"
    ...
    >
      ...
      <p class="msg">Are you sure you want to delete this Pricing ?</p>
...
<script>
import confirmDeleteProfilePopupVue from "../../../organisation/organisationDefaults_new/defaultData/confirmDeleteProfilePopup.vue";
export default {
  props: {
    isDeletePriceingPopupOpen: {
      type: Boolean,
      default: false,
    },
