    ...
    <div>
        <el-row class="tableBorder">
            ...
            <el-row class="row-container" style="height:33px !important; max-height:none !important">
                ...
                <!-- <span style="border-bottom: 1px solid" v-if = "!checkAc()">Required Circuit Conductor Ampacity Per NEC 690.8(A&B)</span>
            ...
            <el-row data-html2canvas-ignore="true" v-if="tableHeader!=='ARRAY TO JUNCTION BOX' && tableHeader!=='INVERTER TO INTERCONNECTION' " 
            class="row-container row-dropdown-input">
                <el-col class="col left"><span>Ground Wire Size</span></el-col>
                <el-col class="col right">
                    <el-select 
                        v-if="! printMode"
                        v-model="groundWireSize"
                        class="tableEditValue numberInput"
                        size="mini"
                        placeholder="Select">
                        <el-option
                     ...
                     <span class="printModeTrue" v-else>{{groundWireSize}}</span>
                </el-col>
            </el-row>


            <el-row v-if="tableHeader!=='ARRAY TO JUNCTION BOX' && tableHeader!=='INVERTER TO INTERCONNECTION' " class="row-container">
        ...
        {{ conduitSizeCalculation(sizeToin2[circuitConductorSize]*conductors + sizeToin2[groundWireSize] )}}
            ...
            <el-row class="row-container">
                ...
                <el-col class="col right">
                    ...
                    <span class="printModeTrue" v-else>{{tagId}}</span>
                </el-col>
            </el-row>
