    ...
    <div class="main-container" id="userInputs">
        <el-row class="tableBorder">
            ...
            <el-row class="row-container">
                ...
                <el-col
                    ...
                    <input
                        ...
                        <!-- <span class="printModeTrue" v-else>{{selectedPanel.company_name}}</span> -->
                </el-col>
            </el-row>
            <el-row class="row-container">
                ...
                <el-col
                    ...
                    <input
                        ...
                        <!-- <span class="printModeTrue" v-else>{{selectedPanel.model}}</span> -->
                </el-col>
            </el-row>
            <el-row class="row-container">
                ...
                <el-col class="col right">
                    ...
                    <!-- <span class="printModeTrue" v-else>{{selectedPanel.vmpp}}</span> -->
            ...
            <el-row class="row-container">
                ...
                <el-col class="col right">
                    ...
                    <!-- <span class="printModeTrue" v-else>{{selectedPanel.impp}}</span> -->
            ...
            <el-row class="row-container">
                ...
                <el-col class="col right">
                    ...
                    <span class="printModeTrue" v-else>{{solarModuleSpecs.voc}}</span>    
                     <!-- <span class="printModeTrue" v-else>{{selectedPanel.voc}}</span> -->
                    <span style="padding: 5px">V</span>
                </el-col>
            </el-row>
            <el-row class="row-container">
                ...
                <el-col class="col right">
                    <input
                        ...
                        <!-- <span class="printModeTrue" v-else>{{selectedPanel.isc}}</span> -->
                    <span style="padding: 5px">A</span>
                </el-col>
            </el-row>
            <el-row class="row-container">
        ...
        <el-row class="tableBorder" style = "text-transform:uppercase;">
            ...
            <el-row class="row-container">
                ...
                <el-col
                    ...
                    <!-- <span class="printModeTrue" v-else>{{selectedInverter.Manufacturer}}</span>  -->
                </el-col>
            </el-row>
            <el-row class="row-container">
                <el-col class="col left"><span>Model Name</span></el-col>
                <el-col
                    ...
                    <!-- <span class="printModeTrue" v-else>{{selectedInverter.Make}}</span> -->
                </el-col>
            </el-row>
            <el-row class="row-container">
                <el-col class="col left">
            ...
            <el-row class="row-container row-dropdown-input" style="height:35px !important; min-height:35px !important;">
                ...
                <el-col class="col right">
                    <!-- <input
                        v-if="! printMode"
                        v-model="inverterSpecs.maxOutputVoltage"
                        type="number"
                        class="tableEditValue numberInput toReduceHeight"
                        placeholder="0"
                        @keyup="$emit('update-inverter', inverterSpecs)"> -->
                    ...
                    <span class="printModeTrue" style="margin-left:10px !important;" v-else>{{inverterSpecs[0].maxOutputVoltage}}</span>     
                     <!-- <span class="printModeTrue" v-else>{{selectedInverter.nominal_dc_voltage}}</span> -->
                    <span style="padding: 5px">V</span>
                </el-col>
            </el-row>
            ...
            <el-row class="row-container" style="height:24px !important; min-height:24px !important;">
                ...
                <el-col class="col right">
                    <input
                     ...
                     <!-- <span class="printModeTrue" v-else>{{selectedInverter.nominal_dc_current}}</span> -->
                    <span style="padding: 5px">A</span>
                </el-col>
            </el-row>
        </el-row>
        ...
        <el-row style = "text-transform:uppercase;" class="tableBorder">
            ...
            <el-row class="row-container">
                ...
                <el-col class="col right">
                    <span  v-if="! printMode" style="padding: 5px; margin-left: 10%;">{{ roofTopTemp }}</span>
            ...
            <el-row data-html2canvas-ignore="true" class="row-container row-dropdown-input">
                ...
                <!-- <button @click="confirmOnClickAction">save</button> -->
            </el-row>
        </el-row>
    </div>
</template>
    ...
    methods: {
       ...
       async callApiForOptimizer(){
         ...
         saveSelectedPanel(selectedPan){
             console.log("event triggered when panel selected",this.selectedPanel);
           ...
           checkSelectedPanel(){
                console.log("selected panel is", this.selectedPanel);
           },
